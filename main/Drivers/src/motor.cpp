...
#define PWM_CYCLE 500 /*0.1us*500  20khz */
Motor::Motor(uint8_t pole_pairs, int8_t direction, float max_voltage,
    ...
    : 
        ...
        encoder(i2c_port), // Initialize AS5600 encoder
...
void Motor::initADC()
{
    ...
    platform_adc_register_channel(adc_unit, u_chanel, &u_adc_channel); //gpio9
    platform_adc_register_channel(adc_unit, v_chanel, &v_adc_channel); //gpio9
...
void Motor::debug() {
    ...
    // }
    int vol = 0;
    platform_adc_get_voltage(&u_adc_channel,&vol);
